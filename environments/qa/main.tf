...
# Entorno QA — costo intermedio
# Cambios justificados:
#   - Sin NAT Gateways (igual que dev, ahorro ~$64/mes)
#   - Sin SQS Interface Endpoint (ahorro ~$14/mes)
#   - Sin multi-AZ (HA no requerida en QA)
#   - Retención de logs: 7 días
#   - Throttling: 1,000 RPS (más cercano a prod para pruebas de carga ligeras)
#   - Expiración S3: valores intermedios
